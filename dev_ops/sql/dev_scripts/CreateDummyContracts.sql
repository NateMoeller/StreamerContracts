...
BEGIN
    FOR i in 1..numContracts LOOP
		...
		INSERT INTO contracts VALUES (uuid_generate_v1(), random_user1, random_user2, games[floor(random() * ((array_length(games, 1))-1+1) + 1)], descriptions[floor(random() * ((array_length(descriptions, 1))-1+1) + 1)], NOW(), NULL, NULL, NOW() + interval '3' day, NULL, NULL, NULL, NULL, false, 'OPEN', NULL);
    END LOOP;
END;

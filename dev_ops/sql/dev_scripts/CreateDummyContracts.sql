...
BEGIN
    FOR i in 1..numContracts LOOP
		...
		INSERT INTO contracts VALUES (uuid_generate_v1(), random_user1, random_user2, null, descriptions[floor(random() * ((array_length(descriptions, 1))-1+1) + 1)], NOW(), NULL, NOW(), NULL, false, false, false);
    END LOOP;
END;

...
psql --username=postgres --file=dev_ops/sql/CreateDatabase.sql

psql --username=application_user --dbname=streamercontractsdb --file=dev_ops/sql/CreateSchema.sql

4. Create Dummy Data

psql --username=postgres --dbname=streamercontractsdb --file=dev_ops/sql/CreateDummyData.sql
